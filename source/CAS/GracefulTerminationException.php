 ...
 * PHP Version 5
 *
 * @file     CAS/GracefulTerminationException.php
...
/**
 * An exception for terminating execution or to throw for unit testing.
 *
 * @class    GracefulTerminationException
 * @category Authentication
 * @author   Joachim Fritschi <jfritschi@freenet.de>
 * @author   Adam Franco <afranco@middlebury.edu>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 * @link     https://wiki.jasig.org/display/CASC/phpCAS
 */
class GracefulTerminationException extends RuntimeException implements CASExceptionInterface
{
    /**
    ...
    /**
     * Force CAS to throw Exceptions instead of calling exit()
     * Needed for unit testing. Generally should not be used in production due to
     * an increase in Apache error logging if GracefulTerminiationExceptions
