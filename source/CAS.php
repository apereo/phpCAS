...
class phpCAS
{
    ...
    /**
     * This variable is used to store phpCAS validation
     *
     */
    private static $_PHPCAS_VALIDATOR;
    ...
    public static function client($server_version, $server_hostname,
        ...
        phpCAS :: traceBegin();
        if (self::$_PHPCAS_DEBUG) {
            $validator = CAS_Util_Validator::getInstance();
            $validator->validateParameters(func_get_args());
            $validator->checkClientConflict();
        }
        ...
        if (self::$_PHPCAS_DEBUG) {
            $validator->setClient(self::$_PHPCAS_CLIENT);
        }
        phpCAS :: traceEnd();
    }
    ...
    */
     ...
     * @return void
     */
    public static function setPGTStorage(CAS_PGTStorage $storage)
    {
        phpCAS :: traceBegin();
        if (self::$_PHPCAS_DEBUG) {
            $validator = CAS_Util_Validator::getInstance();
            $validator->validateParameters(func_get_args());
            $validator->checkClientIsProxy();
            $validator->checkClientBeforeAuthenticationCalled();
        }
    ...
    public static function setPGTStorageDb($dsn_or_pdo, $username='',
        ...
        self::$_PHPCAS_CLIENT->setPGTStorageDb(
            $dsn_or_pdo, $username, $password, $table, $driver_options
        );
        phpCAS :: traceEnd();
    }
    ...
    */
    ...
    public static function getProxiedService ($type)
    {
        ...
        if (self::$_PHPCAS_DEBUG) {
            ...
            $validator->validateParameters(func_get_args());
            $validator->checkClientIsProxy();
            $validator->checkClientAuthenticationCalledSucessful();
        }
     ...
     */
    public static function initializeProxiedService (
     ...
     * error message).
     */
    public static function serviceMail(
        ...
        $res = self::$_PHPCAS_CLIENT->serviceMail(
            $url, $service, $flags, $err_code, $err_msg, $pt
        );
        phpCAS :: traceEnd($res);
        return $res;
    ...
    */
     ...
     * @return void
     */
    public static function setSingleSignoutCallback (
        $function, array $additionalArgs = array()
    ) {
        if (self::$_PHPCAS_DEBUG) {
            $validator = CAS_Util_Validator::getInstance();
            $validator->validateParameters(func_get_args());
     ...
     * TODO: This function conatins deprecated CAS features and should be fixed
     *
    ...
    public static function allowProxyChain(CAS_ProxyChain_Interface $proxy_chain)
    {
        ...
        if (self::$_PHPCAS_DEBUG) {
            ...
            $validator->validateParameters(func_get_args());
            $validator->checkClientExists();
            $validator->checkClientProtocol(CAS_VERSION_2_0);
        }
