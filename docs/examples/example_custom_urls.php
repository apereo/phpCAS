...
CAS::setServerProxyValidateURL('https://cas.example.org:1443/proxyValidate');
// Override the validation url for any CAS 1.0 validation
//CAS::setServerServiceValidateURL('https://cas.example.org:1443/serviceValidate');
//Override the validation url for any SAML11 validation
//CAS::setServerSamlValidateURL('https://cas.example.org:1443/samlValidate');
